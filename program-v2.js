...
{id:'facepull',n:'Face Pull с резинкой',s:3,min:12,max:20,r:2,rest:60,band:true,h:'Тяни резинку к лицу, локти высоко, в конце разворачивай кисти назад и своди лопатки.',v:'https://www.youtube.com/watch?v=PYj77in44ms'},
...
{id:'pallof',n:'Pallof Press',s:3,min:10,max:15,r:2,rest:60,band:true,side:true,h:'Встань боком к точке крепления. Выжми руки вперёд и не позволяй корпусу повернуться.',v:'https://www.youtube.com/watch?v=FuhasegBeP0'},
...
{id:'lowhigh',n:'Low-to-High Fly с резинкой',s:2,min:12,max:15,r:2,rest:60,band:true,h:'Веди руки снизу-вверх по дуге, локти слегка согнуты. Своди руки перед верхом груди.',v:'https://www.youtube.com/watch?v=N0uLm6RT9zg'},
