...
(function(){
  ...
  function supplementPlan(){
    ...
    return '<div class="card supplement-plan"><b>ДОБАВКИ · ПЛАН ПРИЁМА</b><div class="nutrition-rule">Бета-аланин: 4 г ежедневно, отдельно от учёта белка. Омега-3: 2 капсулы дважды в день с едой по этикетке. Кофеин: 200 мг в таблетке, необязательный приём. Для магния ещё нужен состав.</div>'+
