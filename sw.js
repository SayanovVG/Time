const CACHE='mt-v25';
const ASSETS=['./index.html','./index-v2.html','./styles-v2.css','./program-v2.js','./app-v2.js','./fixes-v2.js','./manifest.json','./icon.svg'];
...
self.addEventListener('fetch',e=>{
  ...
  if(isCode){
    e.respondWith(fetch(e.request).then(resp=>{const clone=resp.clone();caches.open(CACHE).then(c=>c.put(e.request,clone));return resp;}).catch(()=>caches.match(e.request).then(x=>x||caches.match('./index-v2.html'))));
    return;
  }
