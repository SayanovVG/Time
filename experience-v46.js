// MAX TIME v47 — workout UX, records, dashboard, analytics and resilient backups
(function(){
  ...
  body.workout-mode .top .tabs,body.workout-mode .days,body.workout-mode main>h1,body.workout-mode main>.note,body.workout-mode .gear-note,body.workout-mode .mt-week-dashboard{display:none!important}body.workout-mode .top .bar{padding-bottom:12px}body.workout-mode .exercise-card{display:block!important}body.workout-mode .exercise-card.current-ex{margin-top:4px;border-color:rgba(255,138,61,.45);box-shadow:0 18px 54px rgba(0,0,0,.4)}body.workout-mode .exercise-card:not(.current-ex){opacity:.72}body.workout-mode .set{padding:12px 0}body.workout-mode .set input,body.workout-mode .set select{padding:11px 9px}body.workout-mode .check{height:40px;width:40px}
